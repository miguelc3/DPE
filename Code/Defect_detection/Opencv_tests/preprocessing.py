...
def main():
    ...
    path_imgs_nok = "..\..\..\imagens\\test_images\PointGrey\\Dataset_pattern_3\\nok\*.png"
    path_imgs_ok = "..\..\..\imagens\\test_images\PointGrey\\Dataset_pattern_3\\ok\*.png"

    # Path for save images
    path_save_nok = "..\..\..\imagens\\test_images\PointGrey\\Dataset_pattern_3_4\\nok"
    path_save_ok = "..\..\..\imagens\\test_images\PointGrey\\Dataset_pattern_3_4\\ok"

    process(path_imgs_nok, path_save_nok)
    process(path_imgs_ok, path_save_ok)
