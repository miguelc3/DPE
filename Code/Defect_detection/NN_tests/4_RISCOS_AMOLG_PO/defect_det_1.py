...
DATADIR = "..\..\..\..\imagens\\DATASETS_pg\\4_RISCOS_AMOLG_PO\\DATASET_40"
checkpoint_path = '..\\..\\models\\4_RISCOS_AMOLG_PO\\model_1_best\\cp.ckpt'
IMG_SIZE = 224
batch_size = 32
...
# Save the model
model.save('..\\..\\models\\4_RISCOS_AMOLG_PO\\model_1')
