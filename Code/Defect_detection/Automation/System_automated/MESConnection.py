...
class MESConnection:
    ...
    def CreateTelegram(self):
        ...
        """ Add Location Header """
        telegram += "<location lineNo=\"" + self.locationHeader.lineNo + "\" statNo=\"" + self.locationHeader.statNo + \
                    "\" statIdx=\"" + self.locationHeader.statIdx + "\" fuNo=\"" + self.locationHeader.fuNo + \
                    "\" workPos=\"" + self.locationHeader.workPos + "\" toolPos=\"" + self.locationHeader.toolPos + \
                    "\" processNo=\"" + self.locationHeader.processNo + "\" processName=\"" + \
                    self.locationHeader.processName + "\" application=\"" + self.locationHeader.application + "\"/>"
        ...
        if self.resHeadEnabled:
            ...
            telegram += "<body><structs>" + self.arrayItems + "<resHead result=\"" + self.BodyTelegram.result + \
